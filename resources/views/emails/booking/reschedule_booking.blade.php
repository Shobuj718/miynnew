...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div style="line-height: 2;">Your appointment reschedule by {{ $staff->display_name }}, date and time(s) : </div>
											...
											<br>
											<div>
											    Full details on <a href="http://127.0.0.1:8000/login">{{ $booking->first_name." ".$booking->last_name }}</a>
											</div>
