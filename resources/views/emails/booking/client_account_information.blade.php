								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
									<tbody>
										<tr>
											...
											<div style="width: 70px;height: 70px;font-size: 20px;color: #ffffff;line-height: 70px;margin:0 auto;border-radius: 50px;background-color: #4675d9;">{{ substr($user->firstname, 0, 1)."".substr($user->lastname, 0, 1) }}</div>        
											<!-- } -->
											</td>
										</tr>
									</tbody>
								...
								<tbody>
									...
									<tr>
										...
										<td valign="top" style="vertical-align: top;">
											<div style="line-height: 2;">Dear {{ $user->firstname." ".$user->lastname }}, </div>
											<div>An account has been created on <a href="https://app.miyn.net/login"> MIYN </a> for {{ $user->email }}.</div>
											
											
											<br>
											
											<div>Your Username/Email: {{$user->email}}</div>
