								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
									<tbody>
										<tr>
											...
											<div style="width: 70px;height: 70px;font-size: 20px;color: #ffffff;line-height: 70px;margin:0 auto;border-radius: 50px;background-color: #4675d9;">first name</div>        
											<!-- } -->
											</td>
										</tr>
									</tbody>
								...
								<tbody>
									...
									<tr>
										...
										<td valign="top" style="vertical-align: top;">
											<div style="line-height: 2;">Dear {{ $booking->first_name." ".$booking->last_name }}, </div>
											<div>Appoinment service  {{ $booking->service_name }} Cancel from admin.</div>
											
											<hr>
											<h3 style="text-align: center;"> Appointment Request Cacel by {{ $booking->staff_name }}</h3>
											<hr>

											<div style="text-align: center;">
												<h3 style="font-size: 15px;">{{ $booking->service_name }}</h3>
