...
<!-- Basic Form Inputs card start -->
    <div class="card">
        ...
        <div class="card-block booking-container">
                                  ...
                                  <div class="mesgs">
                                    ...
                                    <div class="type_msg">
                                      <div class="input_msg_write">
                                        <form id="" method="post" action="{{url('/message-send-from-admin')}}" >
                                            @csrf
                                            ...
                                            <input type="hidden" name="phone" id="phone" value="{{$booking->phone}}">
            ...
            <a style="color:#fff;" class="btn active-btn" href="{{ route('view.accept.appointment', $booking->id) }}">Accept</a>
