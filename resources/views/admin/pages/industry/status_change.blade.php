        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <h5> Active/De-Active Industry </h5>
                </div>
                <div class="card-block">
                    <form id="main" method="post" action="{{ route('industry.status.change', $industry->slug) }}" novalidate>
                        @csrf
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Industry Name</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="name" id="name" value="{{ $industry->name }}" readonly="" placeholder="Industry Name" required="">
