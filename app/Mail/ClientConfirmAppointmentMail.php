...
class ClientConfirmAppointmentMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->from('app@miyn.net', $staff->display_name)
                    ->subject('Appointment with '.$staff->display_name)
                    ->view('emails.booking.booking_confirmed',compact('booking', 'booking2', 'service', 'staff', 'category', 'contactInfo'));
    }
}
