        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    <form id="main" method="post" action="{{ route('profession.update', $profession->slug) }}" novalidate>
                        @csrf
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Profession Name</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="name" id="name" value="{{ $profession->name }}" placeholder="Industry Name" required="">
...
<script type="text/javascript">
    document.getElementById('industry_id').value = '{{$profession->industry_id}}'
</script>
