								...
								<tbody>
									...
									<tr>
										...
										<td valign="top" style="vertical-align: top;">
											<div style="line-height: 2;">Dear {{ $booking->staff_name }}, </div>
											
											<div>Your appointment with {{$booking->first_name}} has been scheduled.</div>
											<div>A notification with appointment details has also been sent to {{$booking->first_name}}</div>
											...
											<div style="text-align: center;">
											  <a style="color:#fff;" href="https://app.miyn.net/login"><h3 style="width: 270px;height: 30px;background-color: #26db28;padding-top: 5px;border-radius: 4px;margin-left:140px;">
											    ...
											    <a href="https://app.miyn.net/login">Decline</a>
											    <br>
											    <a href="https://app.miyn.net/login">Reply / View Online</a>
											</div>
											<br>
											<div>
											    Full details on <a href="https://app.miyn.net/login">{{ $booking->first_name." ".$booking->last_name }}</a>
											</div>
											...
											<div>Source URL: <a href="{{$contactInfo->website_url ?? '#'}}"></a>{{$contactInfo->website_url ?? '#'}}</div>
