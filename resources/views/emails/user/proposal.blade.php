								...
								<tbody>
									...
									<tr>
										...
										<td valign="top" style="vertical-align: top;">
											<div style="line-height: 2;">Dear {{ $staff->display_name }}, </div>
											<div>A new appointment request has been submitted by {{ ucfirst($booking->first_name)." ".$booking->last_name }}.</div>
											...
											<div style="text-align: center;">
												<h3 style="font-size: 15px;">{{ $service->name }}</h3>
												<div>Proposed Times</div>

												@foreach($dateAndTimes as $key=>$value)
												        <span style="font-size: 20px">{{  \Carbon\Carbon::parse($key)->format('D, M d') }} at</span>
