								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
									<tbody>
										<tr>
											...
											<div style="width: 70px;height: 70px;font-size: 20px;color: #ffffff;line-height: 70px;margin:0 auto;border-radius: 50px;background-color: #4675d9;">{{ substr($user->staff_name, 0, 1) }}</div>        
											<!-- } -->
											</td>
										</tr>
									</tbody>
								...
								<tbody>
									...
									<tr>
										...
										<td valign="top" style="vertical-align: top;">
											<div style="line-height: 2;">Dear, {{ strtoupper($user->staff_name) }}, </div>
											<div>Your appointment with {{ strtoupper($user->first_name).' '.strtoupper($user->last_name) }} is scheduled to take place in 15 minutes at {{ $user->time }} on {{ $user->date }}. Aylward Game.</div>
											
											
											<hr>
											<h3 style="text-align: center;">{{ $user->service_name }} .</h3>
											<h3  style="text-align: center;">Duration: 15 minutes</h3>
											<h3 style="text-align: center;">Your appointment with {{ strtoupper($user->first_name).' '.strtoupper($user->last_name) }} after 15 minutes.</h3>
											<hr>
